"""Montgomery--Dyson phase-spectroscopy diagnostics for OES.

Candidate analysis layer only. It does not assert that atomic or molecular
spectra are generated by the Riemann zeta function or by prime powers.
"""
...
TAU = 2.0 * math.pi
DOMAIN_ROLE = "OES_TRANSITION_LAYER"
...
transition_phase_coordinates = phase_coordinates
